...
def alive():
    while 1:
        time.sleep(100)
        try:
            url = "https://app-wwkiyyx.cloud.okteto.net"
        ...
        time.sleep(100)
        try:
            url = "https://app-a-wwkiyyx.cloud.okteto.net"
            print(datetime.datetime.now(), url)
            print(urllib.request.urlopen(url).read().decode('utf-8'))
        except Exception as ex:
            print(datetime.datetime.now(), ex)
        time.sleep(100)
        try:
            url = "https://app-b-wwkiyyx.cloud.okteto.net"
            print(datetime.datetime.now(), url)
            print(urllib.request.urlopen(url).read().decode('utf-8'))
        except Exception as ex:
            print(datetime.datetime.now(), ex)
        time.sleep(100)
        try:
            url = "https://app-c-wwkiyyx.cloud.okteto.net"
            print(datetime.datetime.now(), url)
            print(urllib.request.urlopen(url).read().decode('utf-8'))
        except Exception as ex:
            print(datetime.datetime.now(), ex)
